...
- **[claude-desktop-debian](https://github.com/aaddrick/claude-desktop-debian)**: Claude Desktop for Linux. Repackages the Windows Electron build for Debian-based distros. Over 40,000 installs. Exists because Anthropic hasn't shipped official Linux support. Maintained with collaborators outside the shop.
